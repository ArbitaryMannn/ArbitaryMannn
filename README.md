...
<ul>
  ...
  <li>
    🛠️ <strong>Core Technology Stack:</strong> C#, JavaScript, TypeScript, PHP, Node.js  
    <br>
    <span style="opacity:0.85;">
      Low-level tooling & debugging: LLDB, Frida, clang/LLVM
    </span>
  </li>
